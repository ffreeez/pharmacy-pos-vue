<template>
  <div style="margin-top: 20px; margin-bottom: 20px; margin-left: 20px; margin-right: 20px;">
    ...
    <el-form :inline="true" :model="searchForm" class="demo-form-inline">
      <el-form-item label="">
        <el-input v-model="searchForm.username" placeholder="请输入要查询的用户名称" />
      </el-form-item>
      <el-form-item>
        <el-button type="primary" @click="onSubmit">查询</el-button>
      </el-form-item>
      <el-form-item>
        <el-button type="primary" @click="getAllUsersInfo">返回</el-button>
      </el-form-item>
      <el-form-item>
...
<script>
import { getAllUsers, deleteUser, createUser, updateIsAdmin, resetPassword, getUserByUsername } from '@/api/user'
